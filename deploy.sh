...
until [ $ATTEMPT -ge 5 ]; do
    ...
    cp -rvf $TRAVIS_BUILD_DIR/{CSharpCompiler,CSharpCompiler.x86,libmonoboehm-2.0.so.1,x86/} Extensions/Oxide.Ext.CSharp/Dependencies/Linux || die_with "Failed to copy changes to Oxide!"
